    ...
    return (
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 20px 80px", fontFamily: "Inter, sans-serif", color: "#333", lineHeight: 1.9 }}>
            ...
            <div style={{ marginTop: 48, borderTop: "1px solid #eee", paddingTop: 20 }}>
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="/privacy" style={{ color: "#555", textDecoration: "none", fontSize: 14, display: "inline-flex", alignItems: "center", gap: 6, fontWeight: 500 }}>
                    Privacy Policy <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
                </a>
            </div>
        </div>
    );
